		...
		<div style={{ ...HorizontalBox, justifyContent: "center"}}>
			<div style={{ ...HorizontalBox, alignItems: 'center', width: "75%", backgroundColor: "#383838", borderRadius: "5px", padding: "2px 5px", justifyContent: "space-around" }} >
				...
				<Tooltip msg="Start Editor">
					<svg className="IconSvg" style={{ height: "28px", width: "30px", marginTop: "5px" }} viewBox="0 0 20 20" fill="#89d185">
				...
				<Tooltip msg="Build">
					<svg className="IconSvg" width="20" height="20" viewBox="0 0 20 20" fill="#757575"
